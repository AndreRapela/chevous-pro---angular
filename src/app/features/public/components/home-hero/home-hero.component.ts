    ...
    <section class="hero-section">
      <div class="container desktop-home-hero">
        ...
        <div class="desktop-hero-lower">
          ...
          <aside class="desktop-booking-preview" aria-label="Prévia de agendamento"><div><span class="avatar avatar-sm" data-cvp-no-localize>AC</span><span><strong data-cvp-no-localize>Ana Clara</strong><small>Perfil aprovado</small></span><b>✓</b></div><dl><div><dt>Serviço</dt><dd>Limpeza residencial</dd></div><div><dt>Horário</dt><dd>Qui, 14h</dd></div></dl><a class="btn btn-primary btn-small" routerLink="/servicos">Agendar agora</a></aside>
        </div>
      </div>
