    ...
    <section class="hero-section">
      <div class="container desktop-home-hero">
        ...
        <div class="desktop-hero-lower">
          <a class="desktop-promo-card" routerLink="/servicos"><span>Oferta de boas-vindas</span><strong>10% na primeira reserva</strong><small>Use o cupom BEMVINDO10</small></a>
