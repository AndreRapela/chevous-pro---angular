    ...
    <section class="hero-section">
      <div class="container desktop-home-hero">
        <div class="desktop-hero-top">
          <div class="desktop-hero-visual" aria-hidden="true"><span class="desktop-hero-orb orb-mint"></span><span class="desktop-hero-orb orb-coral"></span><span class="desktop-hero-orb orb-amber"></span><img src="/images/profissional-limpeza-hero-480.webp" srcset="/images/profissional-limpeza-hero-480.webp 480w, /images/profissional-limpeza-hero-887.webp 887w" sizes="40vw" alt="" width="887" height="1774"><span class="desktop-hero-tag">Profissionais disponíveis</span></div>
        ...
        <div class="desktop-hero-lower">
          <a class="desktop-promo-card" routerLink="/profissionais"><span>Escolha com confiança</span><strong>Perfis avaliados e verificados</strong><small>Compare experiência, avaliações e disponibilidade</small></a>
      ...
      <div class="container hero-stack">
        <article class="hero-banner"><img class="hero-banner-image" src="/images/profissional-limpeza-hero-480.webp" srcset="/images/profissional-limpeza-hero-480.webp 480w, /images/profissional-limpeza-hero-887.webp 887w" sizes="(max-width: 42rem) calc(100vw - 2rem), 50vw" alt="Profissional de limpeza sorrindo com luvas e frasco de limpeza" width="887" height="1774" fetchpriority="high"><div class="hero-banner-shade" aria-hidden="true"></div><div class="hero-banner-copy"><span class="hero-banner-label">Em destaque</span><span class="hero-banner-proof"><span aria-hidden="true">✓</span> Perfis aprovados</span><h1>Serviços para sua casa, sem complicação.</h1><p>Escolha, compare e agende em poucos minutos.</p><a class="btn hero-banner-cta" routerLink="/servicos">Explorar serviços <span aria-hidden="true">→</span></a></div><div class="hero-banner-index" aria-hidden="true"><i></i><i></i><i></i></div></article>
